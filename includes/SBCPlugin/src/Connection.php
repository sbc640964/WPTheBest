...
class Connection
{
    ...
    public function __construct($wpdb, array $config = array(), $alias = null, Container $container = null)
    {
        ...
        $this->eventHandler = $this->container->build('\\SBCPlugin\\EventHandler');
    ...
    {
        class_alias('SBCPlugin\\AliasFacade', $alias);

        $builder = $this->container->build('\\SBCPlugin\\QueryBuilder\\QueryBuilderHandler', array($this));
    ...
    {
        return $this->container->build('\\SBCPlugin\\QueryBuilder\\QueryBuilderHandler', array($this));
    }
